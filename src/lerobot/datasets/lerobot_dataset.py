...
<< << << < HEAD: lerobot/common/datasets/lerobot_dataset.py
# For maintainers, see lerobot/common/datasets/push_dataset_to_hub/CODEBASE_VERSION.md
CODEBASE_VERSION = "v2.0"
LEROBOT_HOME = Path(
    os.getenv("LEROBOT_HOME", "~/.cache/huggingface/lerobot")).expanduser()
== == == =
CODEBASE_VERSION = "v2.1"
>>>>>> > 3efb4410f10c0b21f6e07456b35a9a3b07a1399d: src/lerobot/datasets/lerobot_dataset.py
...
class LeRobotDatasetMetadata:
    def __init__(
        ...
        self.root = Path(
            root) if root is not None else HF_LEROBOT_HOME / repo_id
    ...
    def load_metadata(self):
        ...
        check_version_compatibility(
            self.repo_id, self._version, CODEBASE_VERSION)
    ...
    def save_episode(
        ...
        self.stats = aggregate_stats(
            [self.stats, episode_stats]) if self.stats else episode_stats
